class EraMyStateData {
  ...
  EraMyStateData({String state, String stateCode, int active, int confirmed, int deaths, int recovered, int todayConfirmed,int todayActive, int todayRecovered, int todayDeaths}) {
    this._state = state;
  ...
  factory EraMyStateData.fromJson(Map<String, dynamic> json) {
    return EraMyStateData(
