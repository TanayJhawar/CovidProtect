class FraMyStateData {
  ...
  FraMyStateData({String state, String stateCode, int active, int confirmed, int deaths, int recovered, int todayConfirmed,int todayActive, int todayRecovered, int todayDeaths}) {
    this._state = state;
  ...
  factory FraMyStateData.fromJson(Map<String, dynamic> json) {
    return FraMyStateData(
