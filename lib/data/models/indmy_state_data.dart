class IndMyStateData {
  ...
  IndMyStateData({String state, String stateCode, String lastUpdatedTime, String stateNotes, int active, int confirmed, int deaths, int recovered, int todayConfirmed, int todayRecovered, int todayDeaths}) {
    this._state = state;
  ...
  factory IndMyStateData.fromJson(Map<String, dynamic> json) {
    return IndMyStateData(
      state: json["state"],
  ...
  factory IndMyStateData.fromDistrictJson(Map<String, dynamic> districtJson) {
    return IndMyStateData(
