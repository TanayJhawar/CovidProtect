...
import 'package:sakecblue/ui/widgets/ausstate_combined_chart.dart';
...
class StateDetails extends StatelessWidget {
  ...
  const StateDetails({Key key, @required this.ausstateData}) : super(key: key);
          ...
          BlocBuilder<StateDataBloc, StateDataState>(
            builder: (context, state) {
              if (state is StateDataInitial) {
                BlocProvider.of<StateDataBloc>(context).add(GetStatePatientData(stateCode: ausstateData.stateCode));
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: StateCombinedChart(
                            statePatientDataMap: state.auspatientDataMap,
                          ),
                        ),
                      ),
                    ),
