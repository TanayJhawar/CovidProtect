...
import 'package:sakecblue/ui/widgets/erastate_combined_chart.dart';
...
class StateDetails extends StatelessWidget {
  ...
  const StateDetails({Key key, @required this.erastateData}) : super(key: key);
          ...
          BlocBuilder<StateDataBloc, StateDataState>(
            builder: (context, state) {
              if (state is StateDataInitial) {
                BlocProvider.of<StateDataBloc>(context).add(GetStatePatientData(stateCode: erastateData.stateCode));
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          child: StateCombinedChart(
                            statePatientDataMap: state.erapatientDataMap,
                          ),
                        ),
                      ),
                    ),
