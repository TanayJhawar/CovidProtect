...
class StateCombinedChart extends StatefulWidget {
  final Map<String, List<EraMyStateSingleValue>> statePatientDataMap;
  ...
  List<EraMyStateSingleValue> confirmedCumulativeList = List();
  List<EraMyStateSingleValue> activeCumulativeList = List();
  List<EraMyStateSingleValue> recoveredCumulativeList = List();
  List<EraMyStateSingleValue> deathsCumulativeList = List();
...
class _StateCombinedChartState extends State<StateCombinedChart> {
  ...
  List<EraMyStateSingleValue> mCnfStateDataList = List();
  List<EraMyStateSingleValue> mActiveStateDataList = List();
  List<EraMyStateSingleValue> mRcvrdStateDataList = List();
  List<EraMyStateSingleValue> mDeathsStateDataList = List();
  @override
  void initState() {
    super.initState();
    chartLength = 14;
  ...
  LineChartData buildLineChart({List<EraMyStateSingleValue> cnfStateDataList, List<EraMyStateSingleValue> activeStateDataList, List  rcvrdStateDataList, List<EraMyStateSingleValue> deathsStateDataList, BuildContext context}) {
      ...
      lineTouchData: LineTouchData(
        ...
        touchCallback: (touchResponse) {
          ...
          if (touchResponse.lineBarSpots.length > 0) {
            ...
            EraMyStateSingleValue cnfSingleValue = cnfStateDataList[touchResponse.lineBarSpots.first.spotIndex];
            EraMyStateSingleValue activeSingleValue = activeStateDataList[touchResponse.lineBarSpots.first.spotIndex];
            EraMyStateSingleValue rcvrdSingleValue = rcvrdStateDataList[touchResponse.lineBarSpots.first.spotIndex];
            EraMyStateSingleValue deathsSingleValue = deathsStateDataList[touchResponse.lineBarSpots.first.spotIndex];
  ...
  List<EraMyStateSingleValue> buildLineChartData(List<EraMyStateSingleValue> fullDataList, int _chartLength) {
    print("=====================Function Called======================");
    List<EraMyStateSingleValue> tempList = new List();
  ...
  LineChartBarData buildLineChartBarData({
    List<EraMyStateSingleValue> dataList,
    Color chartColor,
  }) {
  ...
  List<FlSpot> buildFlSpots(List<EraMyStateSingleValue> singleDayData) {
    List<FlSpot> flSpots = List();
    for (int i = 0; i < singleDayData.length; i++) {
      EraMyStateSingleValue item = singleDayData[i];
      flSpots.add(FlSpot(i.toDouble(), item.value.toDouble() / valueDivider));
    }
    return flSpots;
  }

  String getBottomTitle({double index, int numDays, List<EraMyStateSingleValue> data}) {
    if (numDays == 14) {
      if ([
        0,
        3,
  ...
  String getLeftTitle({double index, List<EraMyStateSingleValue> data}) {
