...
class _StateCombinedChartState extends State<StateCombinedChart> {
  ...
  LineChartData buildLineChart({List<MyStateSingleValue> cnfStateDataList, List<MyStateSingleValue> activeStateDataList, List  rcvrdStateDataList, List<MyStateSingleValue> deathsStateDataList, BuildContext context}) {
