...
class StateCombinedChart extends StatefulWidget {
  final Map<String, List<FraMyStateSingleValue>> statePatientDataMap;
  ...
  List<FraMyStateSingleValue> confirmedCumulativeList = List();
  List<FraMyStateSingleValue> activeCumulativeList = List();
  List<FraMyStateSingleValue> recoveredCumulativeList = List();
  List<FraMyStateSingleValue> deathsCumulativeList = List();
...
class _StateCombinedChartState extends State<StateCombinedChart> {
  ...
  List<FraMyStateSingleValue> mCnfStateDataList = List();
  List<FraMyStateSingleValue> mActiveStateDataList = List();
  List<FraMyStateSingleValue> mRcvrdStateDataList = List();
  List<FraMyStateSingleValue> mDeathsStateDataList = List();
  @override
  void initState() {
    super.initState();
    chartLength = 14;
  ...
  LineChartData buildLineChart({List<FraMyStateSingleValue> cnfStateDataList, List<FraMyStateSingleValue> activeStateDataList, List  rcvrdStateDataList, List<FraMyStateSingleValue> deathsStateDataList, BuildContext context}) {
      ...
      lineTouchData: LineTouchData(
        ...
        touchCallback: (touchResponse) {
          ...
          if (touchResponse.lineBarSpots.length > 0) {
            ...
            FraMyStateSingleValue cnfSingleValue = cnfStateDataList[touchResponse.lineBarSpots.first.spotIndex];
            FraMyStateSingleValue activeSingleValue = activeStateDataList[touchResponse.lineBarSpots.first.spotIndex];
            FraMyStateSingleValue rcvrdSingleValue = rcvrdStateDataList[touchResponse.lineBarSpots.first.spotIndex];
            FraMyStateSingleValue deathsSingleValue = deathsStateDataList[touchResponse.lineBarSpots.first.spotIndex];
  ...
  List<FraMyStateSingleValue> buildLineChartData(List<FraMyStateSingleValue> fullDataList, int _chartLength) {
    print("=====================Function Called======================");
    List<FraMyStateSingleValue> tempList = new List();
  ...
  LineChartBarData buildLineChartBarData({
    List<FraMyStateSingleValue> dataList,
    Color chartColor,
  }) {
  ...
  List<FlSpot> buildFlSpots(List<FraMyStateSingleValue> singleDayData) {
    List<FlSpot> flSpots = List();
    for (int i = 0; i < singleDayData.length; i++) {
      FraMyStateSingleValue item = singleDayData[i];
      flSpots.add(FlSpot(i.toDouble(), item.value.toDouble() / valueDivider));
    }
    return flSpots;
  }

  String getBottomTitle({double index, int numDays, List<FraMyStateSingleValue> data}) {
    if (numDays == 14) {
      if ([
        0,
        3,
  ...
  String getLeftTitle({double index, List<FraMyStateSingleValue> data}) {
