import 'package:sakecblue/bloc/indstatewise_bloc.dart';

import 'package:sakecblue/data/repos/indpatientrepository.dart';



import 'package:sakecblue/ui/widgets/ind_details.dart';
...
class IndHomePage extends StatelessWidget {
                          ...
                          BlocBuilder<StatewiseBloc, StatewiseState>(
                            builder: (context, state) {
                              ...
                              if (state is StatewiseLoaded) {
                                return showIndiaDetails(state.indpatientDataMap);
                              }
  ...
  Widget showIndiaDetails(Map<String, List> indpatientDataMap) {
    return IndiaDetails(
      indpatientDataMap: indpatientDataMap,
    );
  }
