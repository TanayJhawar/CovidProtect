...
import 'package:sakecblue/Stats/ui/pages/state_page.dart';
...
class PatientDataTable extends StatefulWidget {
  ...
  PatientDataTable(
      {Key key, @required this.stateWiseData, @required this.isStateDataTable})
      : super(key: key);
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Expanded(
              ...
              child: Tooltip(
                message:
                    widget.isStateDataTable ? "State Name" : "District Name",
                child: Container(
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    ...
                    settings: RouteSettings(
                        name: "home/india/${stateData.state}/details_page"),
                  ),
                );
              }
            },
                      ...
                      children: <Widget>[
                        stateData.todayConfirmed != 0
                            ? Text(
                                stateData.state != "Total"
                                    ? (stateData.todayConfirmed.isNegative
                                            ? ""
                                            : "+") +
                                        Helper.formatNumber(
                                            stateData.todayConfirmed)
                                    : Helper.formatNumberAsThousands(
                                        stateData.todayConfirmed),
                                style: TextStyle(
                                  fontWeight: FontWeight.w900,
                                  fontSize: 12,
                        ...
                        Text(
                          stateData.confirmed == 0
                              ? "-"
                              : (stateData.state != "Total" &&
                                      stateData.confirmed < 100000
                                  ? Helper.formatNumber(stateData.confirmed)
                                  : Helper.formatNumberAsThousands(
                                      stateData.confirmed)),
                          style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        stateData.todayActive != 0
                            ? Text(
                                stateData.state != "Total"
                                    ? (stateData.todayActive.isNegative
                                            ? ""
                                            : "+") +
                                        Helper.formatNumber(
                                            stateData.todayActive)
                                    : Helper.formatNumberAsThousands(
                                        stateData.todayActive),
                                style: TextStyle(
                                  fontWeight: FontWeight.w900,
                        ...
                        Text(
                          stateData.active == 0
                              ? "-"
                              : (stateData.state != "Total" &&
                                      stateData.active < 100000
                                  ? Helper.formatNumber(stateData.active)
                                  : Helper.formatNumberAsThousands(
                                      stateData.active)),
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        stateData.todayRecovered != 0
                            ? Text(
                                stateData.state != "Total"
                                    ? (stateData.todayRecovered.isNegative
                                            ? ""
                                            : "+") +
                                        Helper.formatNumber(
                        ...
                        Text(
                          stateData.recovered == 0
                              ? "-"
                              : (stateData.state != "Total" &&
                                      stateData.recovered < 100000
                                  ? Helper.formatNumber(stateData.recovered)
                                  : Helper.formatNumberAsThousands(
                                      stateData.recovered)),
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        stateData.todayDeaths != 0
                            ? Text(
                                stateData.state != "Total"
                                    ? (stateData.todayDeaths.isNegative
                                            ? ""
                                            : "+") +
                                        Helper.formatNumber(
                        ...
                        Text(
                          stateData.deaths == 0
                              ? "_"
                              : (stateData.state != "Total" &&
                                      stateData.deaths < 100000
                                  ? Helper.formatNumber(stateData.deaths)
                                  : Helper.formatNumberAsThousands(
                                      stateData.deaths)),
                          style: TextStyle(
                            fontWeight: FontWeight.w600,
